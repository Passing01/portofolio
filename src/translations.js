export const translations = {
    fr: {
        ...
        synodCaseStudy: {
            ...
            subtitle: 'Le Protocole de Confiance par Consensus Récursif',
            vision_title: '1. Vision & Mission',
            vision_desc: "SYNOD AI n'est pas un simple service d'étiquetage de données. C'est une <strong>usine à vérité</strong> qui utilise la compétition entre plusieurs intelligences artificielles pour générer, vérifier et certifier des données d'un niveau de pureté supérieur à l'expertise humaine seule. L'objectif final est de construire une infrastructure IA totalement autonome et souveraine, en utilisant des modèles locaux (Ollama).",
            arch_title: "2. L'Architecture de Consensus",
            agent1_title: "L'Atelier (Agent 1)",
            agent1_desc: "Le Générateur. Il produit la solution initiale, détaillé étape par étape (Chain of Thought).",
            agent2_title: "La Critique (Agent 2)",
            agent2_desc: "Le Maître Sévère. Cherche les failles, les biais et les hallucinations sans complaisance.",
            agent3_title: "Le Gouverneur (Agent 3)",
            agent3_desc: "Le Juge. Tranche le débat. Si le consensus n'est pas parfait, la tâche est renvoyée en correction.",
            stack_title: "3. La Stack Technique",
            stack_orchestration: "<strong>Orchestration IA :</strong> LangGraph (Gestion des boucles \"Débat-Correction\") et Pydantic pour la validation stricte.",
            stack_inference: "<strong>Inférence :</strong> Modèles locaux via Ollama, LLMs Open-Source (Llama 3, Mistral) sur Groq pour une vitesse d'inférence fulgurante, et LiteLLM comme gateway.",
            stack_storage: "<strong>Stockage & BDD :</strong> PostgreSQL (avec pgvector pour les embeddings), Redis (Task Queue et mémoire à court terme).",
            strategy_title: "4. Stratégie de Souveraineté : Le Cycle de Promotion",
            strategy_desc: "Le cœur de l'autonomie du système. L'objectif n'est pas de rester dépendant des APIs propriétaires, mais de les utiliser comme mentors pour éduquer des modèles locaux (le \"Petit Frère\").",
            grade1: "<strong>Grade 1 (Shadow Learning) :</strong> Le modèle local écoute et apprend des débats entre les APIs payantes.",
            grade2: "<strong>Grade 2 (L'Exécutant) :</strong> Le modèle local prend la place de l'Agent 1 (Générateur) et se fait critiquer.",
            grade3: "<strong>Grade 3 (Le Critique) :</strong> Le modèle local devient l'Agent 2 et détecte les erreurs.",
            grade4: "<strong>Grade 4 (Le Gouverneur) :</strong> Autonomie totale. Le modèle local est le juge suprême, 100% souverain et local."
        },
        resume: {
            title: 'Mon CV',
    ...
    en: {
        ...
        synodCaseStudy: {
            ...
            subtitle: 'The Trust Protocol by Recursive Consensus',
            vision_title: '1. Vision & Mission',
            vision_desc: "SYNOD AI is not just a simple data labeling service. It is a <strong>truth factory</strong> that uses competition between multiple artificial intelligences to generate, verify, and certify data with a purity level higher than human expertise alone. The ultimate goal is to build a fully autonomous and sovereign AI infrastructure using local models (Ollama).",
            arch_title: "2. The Consensus Architecture",
            agent1_title: "The Workshop (Agent 1)",
            agent1_desc: "The Generator. Produces the initial solution, detailed step by step (Chain of Thought).",
            agent2_title: "The Critic (Agent 2)",
            agent2_desc: "The Strict Master. Actively seeks out flaws, biases, and hallucinations without compromise.",
            agent3_title: "The Governor (Agent 3)",
            agent3_desc: "The Judge. Settles the debate. If consensus is not perfect, the task is sent back for correction.",
            stack_title: "3. The Tech Stack",
            stack_orchestration: "<strong>AI Orchestration:</strong> LangGraph (\"Debate-Correction\" loop management) and Pydantic for strict validation.",
            stack_inference: "<strong>Inference:</strong> Local models via Ollama, Open-Source LLMs (Llama 3, Mistral) on Groq for blazing fast inference speed, and LiteLLM as gateway.",
            stack_storage: "<strong>Storage & DB:</strong> PostgreSQL (with pgvector for embeddings), Redis (Task Queue and short-term memory).",
            strategy_title: "4. Sovereignty Strategy: The Promotion Cycle",
            strategy_desc: "The core of the system's autonomy. The goal is not to remain dependent on proprietary APIs, but to use them as mentors to educate local models (the \"Little Brother\").",
            grade1: "<strong>Grade 1 (Shadow Learning):</strong> The local model listens and learns from debates between paid APIs.",
            grade2: "<strong>Grade 2 (The Executor):</strong> The local model takes the place of Agent 1 (Generator) and gets criticized.",
            grade3: "<strong>Grade 3 (The Critic):</strong> The local model becomes Agent 2 and detects errors.",
            grade4: "<strong>Grade 4 (The Governor):</strong> Total autonomy. The local model is the supreme judge, 100% sovereign and local."
        },
        resume: {
            title: 'Resume',
